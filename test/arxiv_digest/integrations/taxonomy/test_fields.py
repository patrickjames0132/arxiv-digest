"""fields: the S2 fields-of-study vocabulary (fields + valid_fields)."""

from __future__ import annotations

from arxiv_digest.integrations.taxonomy import fields


def test_fields_are_the_expected_vocabulary():
    listed = fields.all_fields()
...
def test_valid_fields_matches_the_listed_fields_and_rejects_junk():
    ...
    assert valid == set(fields.all_fields())
